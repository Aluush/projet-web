...
<body>
 ...
 <div class="form-group">
    ...
    <div>
      <label for="cv">Contrat de travail signé :</label>
      <input type="file" id="cv" placeholder="Contrat de travail signé" name="fiche_entrep" accept="application/pdf" >
    </div>
   
      </br></br>
       
 <div class="form-group">  <button onclick="verifier()" name="btn-ajt-rec-admin" type="submit" class="button2">
  Sign up
</button>
 </div>
