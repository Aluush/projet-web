...
$query = "SELECT id FROM recruteurs WHERE gmail_rec='$name' LIMIT 1";
    ...
    <section class="dashboard">
        <div class="top">
            ...
            <?php
                     ...
                     $query ="SELECT  * FROM recruteurs where gmail_rec='$name' LIMIT 1" ;
                ...
                <div class="activity-data">
                    <table>
                        ...
                        <?php
                         ...
                         $requete = "SELECT id FROM recruteurs WHERE gmail_rec=:names";
...
<hr>
            ...
            <div style="margin-bottom=200px;" class="activity">
                <div style="margin-bottom=200px;"class="title" >
                ...
                <div  style="margin-top:-65px;  margin-left:200px; margin-bottom=200px; ">
                
                     <label class="ab">trier par offre :  </label>
                    <input style="border-radius:40px; height:30px;"  style="margin-right:20px;" type="number" name="idof" id="trie1" min="0">
                    <label class="ab">trier par Score :  </label>
                    <input  style="border-radius:40px; height:30px;" type="number" value="0"  name="score" id="trie2" min="0">
                    <button  type="submit" name="scr">trier</button>
                     </div>
                   </form> 
                   ...
                   if(isset($_POST['scr']) ){
                    ...
                    elseif($idof>=0){
                        ...
                        $requete = "SELECT * FROM candidatures 
                                    ...
                                    WHERE offres.id_rec = :id_rec
                                    ORDER BY score ";
                                    } // utilise le paramètre :id_rec au lieu de :names
...
$query = "SELECT message FROM messagerie WHERE id_cand=:id_candidat_postuler AND id_rec=(SELECT id FROM recruteurs WHERE gmail_rec=:name limit 1)";
