...
if(isset($_POST['envoi_message'])){
    if(isset($_POST['destinataire'],$_POST['message']) && !empty($_POST['destinataire']) && !empty($_POST['message'])) {
         ...
         $id_rec = $bdd->prepare('SELECT id FROM recruteurs WHERE gmail_rec=?');
    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li>
                <?php
                if(isset($_SESSION['id_candidat_postuler'])){
    ...
    <section class="dashboard">
        <div class="top">
            ...
            <?php
                     ...
                     $query ="SELECT  * FROM candidats where gmail_cand='$name' and mdps_cand='$pass' LIMIT 1" ;
