...
foreach($lang as $key){
    ...
    elseif($key['nom_lang']=='Swift'){
        $note4+=3;
    }
    elseif($key['nom_lang']=='Kotlin'){
        $note4+=4;
    }
    elseif($key['nom_lang']=='Objective-C<'){
        $note4+=4;
    }
    elseif($key['nom_lang']=='SQL'){
        $note4+=4;
    }
    elseif($key['nom_lang']=='Perl'){
        $note4+=3;
    }
    elseif($key['nom_lang']=='Go'){
        $note4+=3;
    }
    elseif($key['nom_lang']=='MATLAB'){
        $note4+=4;
    }
    elseif($key['nom_lang']=='Scala'){
        $note4+=4;
    }
    elseif($key['nom_lang']=='Lua'){
        $note4+=4;
    }
    elseif($key['nom_lang']=='Rust'){
        $note4+=3;
    }
    elseif($key['nom_lang']=='Dart'){
        $note4+=3;
    }
    elseif($key['nom_lang']=='Haskell'){
        $note4+=3;
    }elseif($key['nom_lang']=='F#'){
        $note4+=3;
    }elseif($key['nom_lang']=='Groovy'){
        $note4+=3;
    }elseif($key['nom_lang']=='Cobol'){
        $note4+=3;
    }elseif($key['nom_lang']=='Fortran'){
        $note4+=3;
    }
    elseif($key['nom_lang']=='Prolog'){
        $note4+=3;
    }
    elseif($key['nom_lang']=='Ada'){
        $note4+=3;
    }
    elseif($key['nom_lang']=='Smalltalk'){
        $note4+=3;
    }
...
elseif($key['nom_frame']=='AngularJS'){
    $note5+=4;
}
elseif($key['nom_frame']=='React'){
    $note5+=4;
}
elseif($key['nom_frame']=='Vue.js'){
    $note5+=3;
}
elseif($key['nom_frame']=='Ember.js'){
    $note5+=3;
}
elseif($key['nom_frame']=='Backbone.js'){
    $note5+=4;
}
elseif($key['nom_frame']=='Ruby on Rails'){
    $note5+=3;
}
elseif($key['nom_frame']=='Django'){
    $note5+=3;
}elseif($key['nom_frame']=='Flask'){
    $note5+=4;
}
elseif($key['nom_frame']=='Symfony'){
    $note5+=3;
}
elseif($key['nom_frame']=='CodeIgniter'){
    $note5+=3;
}elseif($key['nom_frame']=='Koa.js'){
    $note5+=4;
}
elseif($key['nom_frame']=='Meteor'){
    $note5+=3;
}
elseif($key['nom_frame']=='Spring'){
    $note5+=3;
}
elseif($key['nom_frame']=='Hibernate'){
    $note5+=3;
}elseif($key['nom_frame']=='Struts'){
    $note5+=3;
}elseif($key['nom_frame']=='Flask'){
    $note5+=3;
}elseif($key['nom_frame']=='Pyramid'){
    $note5+=3;
}elseif($key['nom_frame']=='Zend Framework'){
    $note5+=3;
}elseif($key['nom_frame']=='CakePHP'){
    $note5+=3;
}
}
